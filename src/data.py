...
def get_data_loaders(
    ...
    data_loaders["test"] = torch.utils.data.DataLoader(
          ...
          shuffle=False,  # Important: No shuffling for test data
          num_workers=num_workers,
...
def visualize_one_batch(data_loaders, max_n: int = 5):
    ...
    train_dataloader = data_loaders["train"]  # Access the training data loader
    dataset = train_dataloader.dataset 

    # YOUR CODE HERE:
    # Get class names from the train data loader
    class_names  = dataset.classes # YOUR CODE HERE
